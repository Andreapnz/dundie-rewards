"""Módulo responsável por configurar o pytest para o projeto."""
import pytest
...
def go_to_tmpdir(request):  # injeção de dependencia
    """For each test, change the current working directory to tmpdir."""
